...
public class rekeningDataModel {
    ...
    public void addNasabah(Individu nasabah){
        ...
        try{
            queryNasabah = "INSERT INTO nasabah (id, nama, alamat) "
                         + "VALUES (?,?,?);";
            ...
            state.setString(2, nasabah.getNama());
            state.setString(3, nasabah.getAlamat());
            state.execute();
    ...
    public ObservableList<Individu> getIndividu(){
        ...
        try{
            sql = "SELECT id,nama,alamat,nik,npwp FROM "
                + "nasabah NATURAL JOIN individu ORDER BY nama";
    ...
    public ObservableList<Perusahaan> getPerusahaan(){
        ...
        try{
            sql = "SELECT id,nama,alamat,nib FROM "
                + "nasabah NATURAL JOIN perusahaan ORDER BY nama";
